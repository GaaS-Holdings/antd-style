...
export declare const createInstance: <T = any>(options: CreateOptions<T>) => {
    ...
    StyleProvider: import("react").FC<import("../factories/createStyleProvider").StyleProviderProps>;
    ThemeProvider: <T_1 = any, S = any>(props: ThemeProviderProps<T_1, S>) => import("react").ReactElement<any, any> | null;
};
