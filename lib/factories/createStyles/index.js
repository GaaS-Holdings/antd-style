...
exports.createStylesFactory = exports.FasterAntdStyleContext = void 0;
...
var generateStyles = function generateStyles(_ref) {
  ...
  return {
    ...
    theme: res,
    prefixCls: prefixCls,
    fastCx: _utils.classnames
  };
};
var createStylesCallsCounter = 0;
var FasterAntdStyleContext = exports.FasterAntdStyleContext = /*#__PURE__*/(0, _react.createContext)({});
var createStylesFactory = exports.createStylesFactory = function createStylesFactory(_ref4) {
  ...
  return function (styleOrGetStyle, options) {
    ...
    return function (props) {
      ...
      var fasterAntdStyleContext = (0, _react.useContext)(FasterAntdStyleContext);
